      ...
      <div className="flex flex-col md:flex-row gap-4 items-center">
        ...
        <Select value={status} onValueChange={setStatus}>
          ...
          <SelectContent className="rounded-xl border-slate-200 shadow-2xl">
            <SelectItem value="ALL" className="font-bold text-[14px] focus:bg-indigo-50 focus:text-indigo-600 rounded-lg cursor-pointer py-2.5 px-3">Tất cả hồ sơ</SelectItem>
            <SelectItem value="PENDING" className="font-bold text-amber-600 text-[14px] focus:bg-indigo-50 focus:text-indigo-600 rounded-lg cursor-pointer py-2.5 px-3">Chờ phê duyệt</SelectItem>
            <SelectItem value="APPROVED" className="font-bold text-emerald-600 text-[14px] focus:bg-indigo-50 focus:text-indigo-600 rounded-lg cursor-pointer py-2.5 px-3">Đã kích hoạt</SelectItem>
            <SelectItem value="REJECTED" className="font-bold text-rose-600 text-[14px] focus:bg-indigo-50 focus:text-indigo-600 rounded-lg cursor-pointer py-2.5 px-3">Đã từ chối</SelectItem>
          </SelectContent>
        </Select>
