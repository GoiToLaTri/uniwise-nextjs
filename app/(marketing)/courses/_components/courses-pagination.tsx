...
export function CoursesPagination({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-5 bg-white border border-slate-200 rounded-2xl shadow-xs">
      <div className="text-sm font-semibold text-slate-500">
        Hiển thị <span className="text-slate-950 font-bold">{startOffset}-{endOffset}</span> trong số{" "}
        <span className="text-indigo-600 font-black">{totalElements}</span> khóa học
      </div>
